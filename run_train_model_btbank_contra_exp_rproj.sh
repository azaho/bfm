...
#SBATCH --mem=196G
#SBATCH -t 6:00:00         
#SBATCH --array=1-15 # needs to go to 72
...
learning_rate_options=(0.00075 0.0015 0.003 0.006 0.012)
future_bin_idx_options=(1)
spec_options=(0 1)
use_cls_token_options=(1)
proj_type_options=("None" "random_batch")
...
proj_type1=${proj_type_options[$(((idx1 / (n_rs * n_sl * n_lr * n_fb * n_sp * n_uct)) % n_pt))]}
...
proj_type2=${proj_type_options[$(((idx2 / (n_rs * n_sl * n_lr * n_fb * n_sp * n_uct)) % n_pt))]}

echo "Job 1 - RS: $random_string1, SL: $symmetric_loss1, LR: $learning_rate1, FB: $future_bin_idx1, SPEC: $spec1, UCT: $use_cls_token1, PT: $proj_type1"
echo "Job 2 - RS: $random_string2, SL: $symmetric_loss2, LR: $learning_rate2, FB: $future_bin_idx2, SPEC: $spec2, UCT: $use_cls_token2, PT: $proj_type2"
