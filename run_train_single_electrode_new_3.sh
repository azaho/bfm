...
n_samples_per_bin_options=(1 2 4 8 16 32 64 128)

idx=$(($SLURM_ARRAY_TASK_ID - 1))

n_samples_per_bin1=${n_samples_per_bin_options[$((idx*2))]}
n_samples_per_bin2=${n_samples_per_bin_options[$((idx*2+1))]}
...
python -u train_model_single_electrode_3.py --n_samples_per_bin $n_samples_per_bin1 &
python -u train_model_single_electrode_3.py --n_samples_per_bin $n_samples_per_bin2 &
wait
