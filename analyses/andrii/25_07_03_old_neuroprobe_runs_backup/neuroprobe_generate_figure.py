...
models = [
    {
        ...
        'eval_results_path': f'/om2/user/zaho/bfm/runs/analyses/andrii/25_07_03_old_neuroprobe/eval_results_lite_{split_type}/linear_remove_line_noise/'
    },
    {
        'name': 'Linear (STFT)',
        'color_palette': 'viridis', 
        'eval_results_path': f'/om2/user/zaho/bfm/runs/analyses/andrii/25_07_03_old_neuroprobe/eval_results_lite_{split_type}/linear_fft_realimag/'
    },
    {
        'name': 'Linear (spectrogram)',
        'color_palette': 'viridis',
        'eval_results_path': f'/om2/user/zaho/bfm/runs/analyses/andrii/25_07_03_old_neuroprobe/eval_results_lite_{split_type}/linear_fft_abs/'
    },
    {
    ...
    },
    {
        ...
        'eval_results_path': f'/om2/user/zaho/bfm/runs/analyses/andrii/25_07_03_old_neuroprobe/eval_results_lite_{split_type}/brainbert_frozen_mean_granularity_{-1}/'
    },
    # {
    #     'name': 'PopT (frozen)',
    #     'color_palette': 'magma',
    ...
    # },
    {
        'name': 'PopT',
        'color_palette': 'magma',
        'eval_results_path': f'/om2/user/zaho/bfm/runs/analyses/andrii/25_07_03_old_neuroprobe/eval_results_popt/popt_{split_type}_results.csv'
    }
]
...
# Save figure
save_path = os.path.join(os.path.dirname(__file__), f'neuroprobe_eval_lite_{split_type}.pdf')
