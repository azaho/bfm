...
models = [
...
] + [
    {
        ...
        'color_palette': 'rainbow',
        'eval_results_path': f'runs/analyses/andrii/25_07_14_andrii0_evals/eval_results_lite_{split_type}/linear_{"mse_ar_lr0.003_wd0.0_dr0.2_rR1_t20250821_100316"}_epoch{model_epoch}_{feature_type}/',
        'pad_x': 1 if model_epoch==0 else 0,
    } for feature_type in ['keepall'] for model_epoch in [0, 5] # , 'meanE', 'meanT', 'meanT_meanE'
] + [
    {
        'name': f'MSE random masking epoch {model_epoch} ({feature_type})',
        'color_palette': 'rainbow',
        'eval_results_path': f'runs/analyses/andrii/25_07_14_andrii0_evals/eval_results_lite_{split_type}/linear_{"mse_rm_lr0.003_wd0.0_dr0.2_rR1_t20250821_100316"}_epoch{model_epoch}_{feature_type}/',
        'pad_x': 1 if model_epoch==0 else 0,
    } for feature_type in ['keepall'] for model_epoch in [0, 5] # , 'meanE', 'meanT', 'meanT_meanE'
] + [
    {
        ...
        'color_palette': 'rainbow',
        'eval_results_path': f'runs/analyses/andrii/25_07_14_andrii0_evals/eval_results_lite_{split_type}/linear_{"mse_mtm_lr0.003_wd0.0_dr0.2_rR1_t20250821_100316"}_epoch{model_epoch}_{feature_type}/',
        'pad_x': 1 if model_epoch==0 else 0,
    } for feature_type in ['keepall'] for model_epoch in [0, 5] # , 'meanE', 'meanT', 'meanT_meanE'
] + [
    # {
