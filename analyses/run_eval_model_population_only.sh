...
python -u analyses/btbench_eval_population.py --subject $SUBJECT_ID --trial $TRIAL_ID --eval_names $EVAL_NAMES_STR --verbose --model_dir M_nst8_dm192_nh12_nl5_5_stbs0.0625_mxt48_mbfNone_lr0.003_rMTB3 --overwrite
