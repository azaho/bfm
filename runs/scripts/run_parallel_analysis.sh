...
for pair in "${subject_trials[@]}"; do
    ...
    python -m analyses.roshnipm.visualize_attention --single_file "runs/data/$MODEL_DIR/key_electrodes/model_epoch$MODEL_EPOCH/key_electrodes_btbank${subject_id}_${trial_id}.npy" --output_dir "analyses/roshnipm/attention_matrices/roshnipm"
