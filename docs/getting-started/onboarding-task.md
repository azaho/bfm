...
This will involve making a copy of the `andrii0.py` file in the `training_setup/setups` directory and modifying that copy. The goal is to get the model to train and evaluate, even if the performance is not optimal. No other files will need to be modified.
