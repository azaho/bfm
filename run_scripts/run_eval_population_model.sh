...
#SBATCH --array=1-90  # 285 if doing mini btbench
...
declare -a trials=(2 4 0 1 1 1)

# trained trials
declare -a subjects=(1 2 3 4 7 10)
declare -a trials=(1 0 1 0 0 0)
...
model_dirname="M_nst20_dm192_dmb192_nh12_nl5_5_nf_beT_nII_nSP_pmt0.2_eeL_fk256_rLC7"
model_epoch=9
