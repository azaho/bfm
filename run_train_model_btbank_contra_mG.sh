...
random_string_options=("CONT_FBI1" "CONT_FBI2" "CONT_FBI3")
...
echo "Job 1 - RS: $random_string1, SL: $symmetric_loss1, LR: $learning_rate1, FB: $future_bin_idx1, SPEC: $spec1"
echo "Job 2 - RS: $random_string2, SL: $symmetric_loss2, LR: $learning_rate2, FB: $future_bin_idx2, SPEC: $spec2"
