...
for EVAL_NAME in "${eval_names[@]}"; do
    ...
    python -u analyses/btbench_eval_population.py --subject $SUBJECT_ID --trial $TRIAL_ID --eval_name $EVAL_NAME --verbose --model_dir M_nst8_dm192_nh12_nl5_5_lr0.003_rSL1
    python -u analyses/btbench_eval_electrode.py --subject $SUBJECT_ID --trial $TRIAL_ID --eval_name $EVAL_NAME --verbose --model_dir M_nst8_dm192_nh12_nl5_5_lr0.003_rSL1
done